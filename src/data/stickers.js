...
export const STICKERS = [
  ...
  // ===== マシュマロシール 追加分3 (動物シール 16枚) =====
  { id:'mm-bunny',      name:'うさぎマシュマロ',   series:'marshmallow', imagePath:B+'assets/marshmallow/mm-bunny.png' },
  { id:'mm-chick-2',    name:'ヒヨコマシュマロ',   series:'marshmallow', imagePath:B+'assets/marshmallow/mm-chick-2.png' },
  { id:'mm-penguin',    name:'ペンギンマシュマロ', series:'marshmallow', imagePath:B+'assets/marshmallow/mm-penguin.png' },
  { id:'mm-cat',        name:'ねこマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-cat.png' },
  { id:'mm-panda',      name:'パンダマシュマロ',   series:'marshmallow', imagePath:B+'assets/marshmallow/mm-panda.png' },
  { id:'mm-deer',       name:'しかマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-deer.png' },
  { id:'mm-bear',       name:'くまマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-bear.png' },
  { id:'mm-otter',      name:'カワウソマシュマロ', series:'marshmallow', imagePath:B+'assets/marshmallow/mm-otter.png' },
  { id:'mm-dog',        name:'いぬマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-dog.png' },
  { id:'mm-lion',       name:'ライオンマシュマロ', series:'marshmallow', imagePath:B+'assets/marshmallow/mm-lion.png' },
  { id:'mm-elephant',   name:'ゾウマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-elephant.png' },
  { id:'mm-pig',        name:'ブタマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-pig.png' },
  { id:'mm-cow',        name:'ウシマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-cow.png' },
  { id:'mm-fox',        name:'きつねマシュマロ',   series:'marshmallow', imagePath:B+'assets/marshmallow/mm-fox.png' },
  { id:'mm-tiger',      name:'トラマシュマロ',     series:'marshmallow', imagePath:B+'assets/marshmallow/mm-tiger.png' },
  { id:'mm-baby-seal',  name:'アザラシマシュマロ', series:'marshmallow', imagePath:B+'assets/marshmallow/mm-baby-seal.png' },

  // ===== ノーマル 追加分5 (動物シール 16枚) =====
  { id:'nm-dog',        name:'いぬノーマル',         series:'normal', imagePath:B+'assets/normal/nm-dog.png' },
  { id:'nm-lion',       name:'ライオンノーマル',     series:'normal', imagePath:B+'assets/normal/nm-lion.png' },
  { id:'nm-penguin',    name:'ペンギンノーマル',     series:'normal', imagePath:B+'assets/normal/nm-penguin.png' },
  { id:'nm-cat',        name:'ねこノーマル',         series:'normal', imagePath:B+'assets/normal/nm-cat.png' },
  { id:'nm-squirrel',   name:'リスノーマル',         series:'normal', imagePath:B+'assets/normal/nm-squirrel.png' },
  { id:'nm-koala2',     name:'コアラノーマル',       series:'normal', imagePath:B+'assets/normal/nm-koala.png' },
  { id:'nm-fox2',       name:'きつねノーマル',       series:'normal', imagePath:B+'assets/normal/nm-fox.png' },
  { id:'nm-baby-seal',  name:'アザラシノーマル',     series:'normal', imagePath:B+'assets/normal/nm-baby-seal.png' },
  { id:'nm-panda2',     name:'パンダノーマル',       series:'normal', imagePath:B+'assets/normal/nm-panda.png' },
  { id:'nm-deer',       name:'シカノーマル',         series:'normal', imagePath:B+'assets/normal/nm-deer.png' },
  { id:'nm-koala3',     name:'コアラノーマル２',     series:'normal', imagePath:B+'assets/normal/nm-koala-2.png' },
  { id:'nm-hedgehog',   name:'ハリネズミノーマル',   series:'normal', imagePath:B+'assets/normal/nm-hedgehog.png' },
  { id:'nm-otter2',     name:'カワウソノーマル',     series:'normal', imagePath:B+'assets/normal/nm-otter.png' },
  { id:'nm-squirrel2',  name:'リスノーマル２',       series:'normal', imagePath:B+'assets/normal/nm-squirrel-2.png' },
  { id:'nm-bunny2',     name:'うさぎノーマル',       series:'normal', imagePath:B+'assets/normal/nm-bunny.png' },
  { id:'nm-alpaca',     name:'アルパカノーマル',     series:'normal', imagePath:B+'assets/normal/nm-alpaca.png' },

  // ===== ボンボンドロップ 追加分3 (動物シール 16枚) =====
  { id:'bd-bunny2',     name:'うさぎボンボン',       series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-bunny.png' },
  { id:'bd-chick2',     name:'ヒヨコボンボン',       series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-chick.png' },
  { id:'bd-penguin3',   name:'ペンギンボンボン',     series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-penguin.png' },
  { id:'bd-cat3',       name:'ねこボンボン',         series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-cat.png' },
  { id:'bd-panda2',     name:'パンダボンボン',       series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-panda.png' },
  { id:'bd-deer2',      name:'シカボンボン',         series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-deer.png' },
  { id:'bd-bear2',      name:'クマボンボン',         series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-bear.png' },
  { id:'bd-otter2',     name:'カワウソボンボン',     series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-otter.png' },
  { id:'bd-dog2',       name:'イヌボンボン',         series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-dog.png' },
  { id:'bd-lion2',      name:'ライオンボンボン',     series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-lion.png' },
  { id:'bd-penguin4',   name:'ペンギンボンボン２',   series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-penguin-2.png' },
  { id:'bd-cat4',       name:'ねこボンボン２',       series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-cat-2.png' },
  { id:'bd-squirrel2',  name:'リスボンボン',         series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-squirrel.png' },
  { id:'bd-koala2',     name:'コアラボンボン',       series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-koala.png' },
  { id:'bd-fox2',       name:'キツネボンボン',       series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-fox.png' },
  { id:'bd-baby-seal2', name:'アザラシボンボン',     series:'bonbon-drop', imagePath:B+'assets/bonbon-drop/bd-baby-seal.png' },

  // ===== シャカシャカシール 追加分3 (動物シール 16枚) =====
  { id:'ss-bunny',      name:'うさぎシャカシャカ',       series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-bunny.png' },
  { id:'ss-chick',      name:'ヒヨコシャカシャカ',       series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-chick.png' },
  { id:'ss-penguin',    name:'ペンギンシャカシャカ',     series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-penguin.png' },
  { id:'ss-cat',        name:'ねこシャカシャカ',         series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-cat.png' },
  { id:'ss-panda',      name:'パンダシャカシャカ',       series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-panda.png' },
  { id:'ss-deer',       name:'シカシャカシャカ',         series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-deer.png' },
  { id:'ss-koala',      name:'コアラシャカシャカ',       series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-koala.png' },
  { id:'ss-otter',      name:'カワウソシャカシャカ',     series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-otter.png' },
  { id:'ss-dinosaur',   name:'キョウリュウシャカシャカ', series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-dinosaur.png' },
  { id:'ss-panda-2',    name:'パンダシャカシャカ２',     series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-panda-2.png' },
  { id:'ss-shark',      name:'サメシャカシャカ',         series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-shark.png' },
  { id:'ss-hippo',      name:'カバシャカシャカ',         series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-hippo.png' },
  { id:'ss-frog',       name:'カエルシャカシャカ',       series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-frog.png' },
  { id:'ss-axolotl',    name:'アホロートルシャカシャカ', series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-axolotl.png' },
  { id:'ss-otter-2',    name:'カワウソシャカシャカ２',   series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-otter-2.png' },
  { id:'ss-hedgehog',   name:'ハリネズミシャカシャカ',   series:'shaka-shaka', imagePath:B+'assets/shaka-shaka/ss-hedgehog.png' },

  // ===== ウォーターシール 追加分4 (動物シール 16枚) =====
  { id:'ws-bunny',      name:'うさぎウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-bunny.png' },
  { id:'ws-chick',      name:'ヒヨコウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-chick.png' },
  { id:'ws-penguin',    name:'ペンギンウォーター',     series:'water-seal', imagePath:B+'assets/water-seal/ws-penguin.png' },
  { id:'ws-cat',        name:'ねこウォーター',         series:'water-seal', imagePath:B+'assets/water-seal/ws-cat.png' },
  { id:'ws-elephant',   name:'ゾウウォーター',         series:'water-seal', imagePath:B+'assets/water-seal/ws-elephant.png' },
  { id:'ws-bear',       name:'クマウォーター',         series:'water-seal', imagePath:B+'assets/water-seal/ws-bear.png' },
  { id:'ws-panda',      name:'パンダウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-panda.png' },
  { id:'ws-seal',       name:'アザラシウォーター',     series:'water-seal', imagePath:B+'assets/water-seal/ws-seal.png' },
  { id:'ws-deer',       name:'シカウォーター',         series:'water-seal', imagePath:B+'assets/water-seal/ws-deer.png' },
  { id:'ws-sheep',      name:'ヒツジウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-sheep.png' },
  { id:'ws-fox',        name:'キツネウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-fox.png' },
  { id:'ws-koala',      name:'コアラウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-koala.png' },
  { id:'ws-orca',       name:'シャチウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-orca.png' },
  { id:'ws-giraffe',    name:'キリンウォーター',       series:'water-seal', imagePath:B+'assets/water-seal/ws-giraffe.png' },
  { id:'ws-penguin-2',  name:'ペンギンウォーター２',   series:'water-seal', imagePath:B+'assets/water-seal/ws-penguin-2.png' },
  { id:'ws-crocodile',  name:'ワニウォーター',         series:'water-seal', imagePath:B+'assets/water-seal/ws-crocodile.png' },

  // ===== おしりシール 追加分4 (動物シール 16枚) =====
  { id:'os-bunny',      name:'うさぎのおしり',       series:'oshiri', imagePath:B+'assets/oshiri/bunny-oshiri.png' },
  { id:'os-shiba-2',    name:'柴犬のおしり２',       series:'oshiri', imagePath:B+'assets/oshiri/shiba-new-oshiri.png' },
  { id:'os-cat',        name:'ねこのおしり',         series:'oshiri', imagePath:B+'assets/oshiri/cat-oshiri.png' },
  { id:'os-panda',      name:'パンダのおしり',       series:'oshiri', imagePath:B+'assets/oshiri/panda-oshiri.png' },
  { id:'os-dinosaur',   name:'きょうりゅうのおしり', series:'oshiri', imagePath:B+'assets/oshiri/dinosaur-oshiri.png' },
  { id:'os-pig',        name:'ブタのおしり',         series:'oshiri', imagePath:B+'assets/oshiri/pig-oshiri.png' },
  { id:'os-lion',       name:'ライオンのおしり',     series:'oshiri', imagePath:B+'assets/oshiri/lion-oshiri.png' },
  { id:'os-elephant',   name:'ゾウのおしり',         series:'oshiri', imagePath:B+'assets/oshiri/elephant-oshiri.png' },
  { id:'os-sheep',      name:'ヒツジのおしり',       series:'oshiri', imagePath:B+'assets/oshiri/sheep-oshiri.png' },
  { id:'os-cow',        name:'ウシのおしり',         series:'oshiri', imagePath:B+'assets/oshiri/cow-oshiri.png' },
  { id:'os-penguin-2',  name:'ペンギンのおしり２',   series:'oshiri', imagePath:B+'assets/oshiri/penguin-new-oshiri.png' },
  { id:'os-duck',       name:'アヒルのおしり',       series:'oshiri', imagePath:B+'assets/oshiri/duck-oshiri.png' },
  { id:'os-frog',       name:'カエルのおしり',       series:'oshiri', imagePath:B+'assets/oshiri/frog-oshiri.png' },
  { id:'os-pig-2',      name:'ブタのおしり２',       series:'oshiri', imagePath:B+'assets/oshiri/pig-2-oshiri.png' },
  { id:'os-chick',      name:'ヒヨコのおしり',       series:'oshiri', imagePath:B+'assets/oshiri/chick-oshiri.png' },
  { id:'os-otter',      name:'カワウソのおしり',     series:'oshiri', imagePath:B+'assets/oshiri/otter-oshiri.png' },

  // ===== スペシャル 追加分2 (おなかシール 8枚) =====
  { id:'sp-ohara-bunny',    name:'うさぎおなかシール',     series:'special', imagePath:B+'assets/special/ohara-bunny.png' },
  { id:'sp-ohara-dog',      name:'いぬおなかシール',       series:'special', imagePath:B+'assets/special/ohara-dog.png' },
  { id:'sp-ohara-cat',      name:'ねこおなかシール',       series:'special', imagePath:B+'assets/special/ohara-cat.png' },
  { id:'sp-ohara-panda',    name:'パンダおなかシール',     series:'special', imagePath:B+'assets/special/ohara-panda.png' },
  { id:'sp-ohara-penguin',  name:'ペンギンおなかシール',   series:'special', imagePath:B+'assets/special/ohara-penguin.png' },
  { id:'sp-ohara-pig',      name:'ブタおなかシール',       series:'special', imagePath:B+'assets/special/ohara-pig.png' },
  { id:'sp-ohara-lion',     name:'ライオンおなかシール',   series:'special', imagePath:B+'assets/special/ohara-lion.png' },
  { id:'sp-ohara-elephant', name:'ゾウおなかシール',       series:'special', imagePath:B+'assets/special/ohara-elephant.png' },
  ...
  // ===== アルティメット 追加分 (ジェムシリーズ 8枚) =====
  { id:'ul-gem-bunny',     name:'ジェムバニー',   series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-bunny.png' },
  { id:'ul-gem-kitten',    name:'ジェムキティン', series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-kitten.png' },
  { id:'ul-gem-puppy',     name:'ジェムパピー',   series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-puppy.png' },
  { id:'ul-gem-panda',     name:'ジェムパンダ',   series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-panda.png' },
  { id:'ul-gem-lion',      name:'ジェムライオン', series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-lion.png' },
  { id:'ul-gem-elephant',  name:'ジェムゾウ',     series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-elephant.png' },
  { id:'ul-gem-dolphin',   name:'ジェムイルカ',   series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-dolphin.png' },
  { id:'ul-gem-unicorn',   name:'ジェムユニコーン', series:'ultimate', imagePath:B+'assets/Ultimate/ul-gem-unicorn.png' },
];
